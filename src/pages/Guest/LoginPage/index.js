        ...
        <Row>
            ...
            <Col span={12} className="right-side">
                <div className="d-flex-end mt-60 mr-40">
                    <Button type="primary" shape="round" style={{ width: "120px", backgroundColor: "#ff7c08" }} onClick={() => {nav("/register")}} >
                ...
                <div className="form mt-40 flex-column">
                    <Form form={form} layout="vertical" initialValues={{remember: true}}>
                        ...
                        >
                            ...
                            <span className="forgot-password fs-16 fw-600 primary-color">
                                * Quên mật khẩu
                            </span>
                        </Form.Item>
                    </Form>
