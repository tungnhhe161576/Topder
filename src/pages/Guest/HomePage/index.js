					...
					<Row gutter={[24, 24]}>
						...
						>
							...
							<div className="content">
								...
								<div className="fs-17">
									Bạn cần đặt bàn ngay bây giờ? Với nền tảng
									của chúng tôi, bạn có thể đặt bàn chỉ trong
									vài giây. Không cần chờ đợi, không cần gọi
									điện, chỉ cần click vào nút "Đặt Bàn Ngay"
									và bàn của bạn sẽ được xác nhận
								</div>
						...
						>
							...
							<div className="content">
								...
								<div className="fs-17">
									Bạn luôn lo lắng về việc trễ hẹn? Với tính
									năng quản lý thời gian của nền tảng của
									chúng tôi, bạn có thể dễ dàng theo dõi thời
									gian và nhận thông báo kịp thời. Không bao
									giờ phải lo lắng về việc đến muộn nữa
								</div>
								<div className="booking">
									Đặt Bàn Ngay -{">"}
								</div>
