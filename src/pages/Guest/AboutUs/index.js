      ...
      <AboutUsContainer>
        <div className="session1">
          ...
          <div className="session1-right">
            ...
            >
              {" "}
              Nền Tảng Đặt Bàn Nhanh Việt Nam
            </div>{" "}
            <br />
            <div>
              {" "}
              Chúng tôi mang đến giải pháp tiện lợi và hiệu quả cho người udngf
              trong việc tìm kiếm và đặt chỗ tại các nhà hàng, quán ăn,... Với
              mục tiêu cải thiện trải nghiệm ẩm thực và tiết kiệm thời gian cho
              người dungfm Topder không chỉ đơn giản hóa quá trình đặt bàn mà
              còn cung cấp nhiều ưu đãi và lợi tích độc quyền
            </div>
            <div className="d-flex flex-column mt-30">
              <div className="d-flex mb-20 justify-content-center align-items-center">
                ...
                <div className="ml-20">
                  ...
                  <span>
                    Chỉ với vài thao tác đơn giản, người dùng có thể dễ dàng tìm
                    kiếm và đặt bàn tại các quán hàng và quán ăn
                  </span>
                </div>
              </div>
              <div className="d-flex mb-20 justify-content-center align-items-center">
                ...
                <div className="ml-20">
                  ...
                  <span>
                    {" "}
                    Hợp tác với nhiều nhà hàng uy tín, Topder mang đến cho người
                    dùng các chương trình khuyến mãi, giảm giá đặc biệt và những
              ...
              <div className="d-flex justify-content-center align-items-center">
                ...
                <div className="ml-20">
                  ...
                  <span>
                    Người dùng có thể xem đánh giá từ cộng đồng, cũng như để lại
                    phản hồi sau khi trải nghiệm, góp phần nâng chất lượng dịch
                    vụ của các nhà hàng
                  </span>
                </div>
              </div>
        ...
        <div className="session2 mt-40">
          ...
          >
            <div className="vision d-flex">
              <div className="icon">
                <FontAwesomeIcon
                  className="white fs-25 fw-600"
                  icon={faMagnifyingGlass}
                />
              </div>
              <div className="ml-30">
                <div className="white fw-600 fs-17 mb-5">Tầm nhìn</div>
                <div className="fs-13 pr-30" style={{ color: "#FBFFDD" }}>
                  {" "}
                  Trở thành một trong những nền tảng đặt bàn và cộng đồng ẩm
                  thực hàng đầu Việt Nam{" "}
                </div>
              </div>
            </div>
            <div className="vision d-flex mt-20 mb-20">
              ...
              <div className="ml-30">
                ...
                <div className="fs-13 pr-30" style={{ color: "#FBFFDD" }}>
                  {" "}
                  Mang đến cho thực khách Việt Nam những trải nghiệm ẩm thực
                  trọn vẹnh và tiện lợi{" "}
                </div>
              </div>
            </div>
            <div className="vision d-flex">
              ...
              <div className="ml-30">
                ...
                <div className="fs-13 pr-30" style={{ color: "#FBFFDD" }}>
                  {" "}
                  Là nền tảng tư vấn và hỗ trợ đặt bàn nhanh đồng thời cung cấp
                  cộng đồng tìm kiếm, chia sẻ, đánh giá ẩm thực tại Việt Nam{" "}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="session3">
          ...
          <div
            style={{ color: "#16123a", fontSize: "26px", fontWeight: "800" }}
            className="mt-5"
          >
            ...
            <div className="left-side-session3">
              ...
              <div className="item mt-30">
                <div className="child-item">
                  ...
                  <div className="content">
                    <div
                      className="pl-40 pt-20 pb-20 pr-20"
                      style={{ transform: "skew(15deg)" }}
                    >
                      <div className="fs-18 fw-600 mb-5 ml-10">
                        {" "}
                        Nhanh chóng{" "}
                      </div>
                      <div>
                        {" "}
                        Chỉ vài cú nhấp chuột, bạn có thể dễ đang đặt bàn mà
                        không cần phải gọi điện hay chờ đợi{" "}
                      </div>
                    </div>
                  </div>
                </div>
                <div className="child-item ml-20">
                  ...
                  <div className="content">
                    ...
                    >
                      ...
                      <div>
                        {" "}
                        Cung cấp đầy đủ thông tin về nhà hàng, giúp bạn có cái
                        nhìn toàn diện trước khi quyết định.{" "}
                      </div>
                    </div>
                  </div>
                </div>
                <div className="child-item mt-10">
                  ...
                  <div className="content">
                    ...
                    >
                      ...
                      <div>
                        {" "}
                        Topder mang đến cho bạn những ưu đãi, giảm giá đặc biệt
                        dành riêng cho bạn{" "}
                      </div>
                    </div>
                  </div>
                ...
                <div className="child-item ml-20 mt-10">
                  ...
                  <div className="content">
                    ...
                    >
                      ...
                      <div>
                        {" "}
                        Sẵn sàng giải đáp mọi thắc mắc và hỗ trợ bạn trong quá
                        tình sử dụng dịch vụ{" "}
                      </div>
                    </div>
                  </div>
                </div>
