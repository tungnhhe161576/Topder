...
import { formatNumberToK, getRegexPhoneNumber } from '../../../../lib/stringUtils'
...
const RestaurantDetail = () => {
    ...
    const nextImage = () => {
        setCurrentIndex((prevIndex) => (prevIndex + 1) % restaurantDetail?.images.length)
    };
    const prevImage = () => {
        setCurrentIndex((prevIndex) => (prevIndex - 1 + restaurantDetail?.images.length) % restaurantDetail?.images.length)
    };
    const options = [
                            ...
                            <div className='information'>
                                ...
                                <Row gutter={[16, 16]}>
                                    ...
                                    <Col xs={15} sm={15} md={12} lg={10} xl={10}>
                                        <div className='pl-20'>
                                            <div className='name fw-700 fs-26 mb-16'> {restaurantDetail?.nameRes} </div>
                                            <div className='rate mb-5'>
                                                <Rate className='primary fs-14' value={restaurantDetail?.star} disabled/> - ({restaurantDetail?.totalFeedbacks} đánh giá)
                                            </div>
                                            <div className='name fw-500 fs-16 mb-20'> Loại cửa hàng: {restaurantDetail?.categoryName} </div>
                                            <div className='action-time mb-8'>
                                                <div className='fs-16 fw-600 mb-5'>Giờ hoạt động</div>
                                                <div>Mở cửa: {restaurantDetail?.openTime}</div>
                                                <div>Đóng cửa: {restaurantDetail?.closeTime}</div>
                                            </div>
                                            <div className='fs-16 fw-500 mb-20'>
                                                Giá đặt bàn: <span className='primary'>{formatNumberToK(restaurantDetail?.price)}</span>
                                            </div>
                                            ...
                                            <Form form={form} layout="vertical" className=''>
                                                <Row gutter={[24,0]} className='d-flex justify-content-center'>
                                                    <Col span={10}>
                                                        <Form.Item 
                                                            name='name'
                                                            label={<span className='fs-14 white ml-8'> Tên người nhận bàn  </span>}
                                                            rules={[
                                                    ...
                                                    <Col span={10}>
                                                        <Form.Item 
                                                            name='phonenumber'
                                                            label={<span className='fs-14 white ml-8'> Số điện thoại người nhận  </span>}
                                                            rules={[
                                                    ...
                                                    <Col span={10}>
                                                        <Form.Item 
                                                            name='date'
                                                            label={<span className='fs-14 white ml-8'> Ngày nhận </span>}
                                                            rules={[
                                                    ...
                                                    <Col span={10}>
                                                        <Form.Item 
                                                            name='time'
                                                            label={<span className='fs-14 white ml-8'> Chọn giờ đặt bàn </span>}
                                                            rules={[
                                                    ...
                                                    <Col span={10}>
                                                        <Form.Item 
                                                            name='numberAdult'
                                                            label={<span className='fs-14 white ml-8'> Số người lớn </span>}
                                                            rules={[
                                                    ...
                                                    <Col span={10}>
                                                        <Form.Item 
                                                            name='numberChildren'
                                                            label={<span className='fs-14 white ml-8'> Số trẻ em </span>}
                                                            rules={[
                                                    ...
                                                    <div className='d-flex justify-content-center'>
                                                        <Form.Item 
                                                            name='chooseTable'
                                                        >
                                                            <Button className='choose fs-16 fw-500 mr-10' onClick={() => setOpenModalChooseTable(true)}>
                                                                Chọn bàn
                                                            </Button>
                                                        </Form.Item>
                                                        <Form.Item 
                                                            name='ChooseFoods'
                                                        >
                                                            <Button className='choose fs-16 fw-500' onClick={() => setOpenModalChooseFood(true)}>
                                                                Chọn món ăn
                                                            </Button>
                                                        </Form.Item>
                                                    </div>
