...
const HistoryBooking = () => {
    ...
    const items = [
        ...
        },
        {
          ...
          children: <Complete orderHistory={orderHistory} loading={loading} orderDetail={orderDetail} isDetail={isDetail} setIsDetail={setIsDetail} handleViewDetail={handleViewDetail}/>,
        },
        {
          key: '5',
          label: <span className="fw-500 fs-18"> Đã hủy </span>,
          children: <Cancel orderHistory={orderHistory} loading={loading} orderDetail={orderDetail} isDetail={isDetail} setIsDetail={setIsDetail} handleViewDetail={handleViewDetail}/>,
        },
    ];
