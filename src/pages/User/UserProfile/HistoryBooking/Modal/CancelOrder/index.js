            ...
            <div>
                {
                    ...
                    ? <div className="mb-20 fs-18 mt-20 pl-30">
                            Theo chính sách của nhà hàng, bạn sẽ được hoàn lại <span className="fw-500">{100 - restaurantFee?.cancellationFeePercent}%</span> về ví của bạn. Bạn có chắc là muốn hủy đơn hàng này không?
                        </div>
