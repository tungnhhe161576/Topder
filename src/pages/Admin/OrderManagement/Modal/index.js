                ...
                <Row gutter={[16, 16]}>
						<Col span={24}>
                            <div className="d-flex">
                                <div className="fs-16 fw-500 w-40 d-flex flex-column" style={{ color: "gray" }}>
                                ...
                                <div className="fs-16 fw-500 d-flex flex-column">
                                    ...
                                    <span> {formatNumberToK(open?.totalAmount)} </span>
                                    <span> Ngày: {dayjs(open?.dateReservation).format('DD-MM-YYYY')} {" "} {open?.timeReservation}</span>
                                    <span>Người lớn: {open?.numberPerson}, Trẻ nhỏ: {open?.numberChild}</span>
                                    ...
                                    <Col span={12}>
                                        ...
                                        <Row gutter={[16, 16]} className="w-100 ">
                                            {open?.orderTables.length === 0 ? (
                                                ...
                                                open?.orderTables.slice(0, 1).map(
                                                    (t, index) => (
                                                        <Col
                                                            span={12}
                                                            key={index}
                                    ...
                                    <Col span={12}>
                                        ...
                                        <Row gutter={[16, 16]} className="w-100">
                                            {open?.orderMenus.length === 0 ? (
                                                ...
                                                open?.orderMenus.slice(0, 2).map((t, index) => (
                                                    <Col
                                                        span={10}
                                                        key={index}
                                                        className="w-100"
