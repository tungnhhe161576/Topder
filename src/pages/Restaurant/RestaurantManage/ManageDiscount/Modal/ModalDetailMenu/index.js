...
const ModalDetailMenu = ({ open, onCancel }) => {
	...
	return (
		<div>
			...
			>
				<div className="title-type-1">Menu áp dụng</div>
				<div className="mt-20 mb-30">
					{open?.discountMenuDtos.length === 0 ? (
						<div className="fs-18 fw-500 red w-90 m-auto">
							Nhà hàng chưa áp giá cho bất kỳ món ăn nào
						</div>
					) : (
						<div>
							<Row gutter={[16, 16]}>
								{open?.discountMenuDtos.map((i) => (
									...
									>
										...
										<div className="d-flex flex-column align-items-center">
											...
											<div className="primary fs-15 fw-500">
												{" "}
												{
													i?.discountMenuPercentage
												}%{" "}
											</div>
										</div>
									</Col>
