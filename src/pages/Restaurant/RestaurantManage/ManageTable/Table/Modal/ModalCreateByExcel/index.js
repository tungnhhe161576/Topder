...
import { ModalCreateByExcelContainer } from "../../../../ManageMenu/Menu/Modal/ModalCreateByExcel/styled";
import CustomModal from "../../../../../../../components/Common/ModalCustom";
import UserService from "../../../../../../../services/UserService";
import * as XLSX from "xlsx";
import { useState } from "react";

const ModalCreateTableByExcel = ({open, onCancel, onOk, userId}) => {
    ...
    const handleCreateMenu = async () => {
        try {
            ...
            await UserService.createTableByExcel( userId, file )
            message.open({
...
export default ModalCreateTableByExcel;