		...
		<ManageInfoContainer>
			<div>
				...
				<div className="des mt-20">
					<Row gutter={[16, 16]}>
						<Col span={14}>
							<div className="pl-20 title-type-1 mb-20">Thông tin cơ bản</div>
							<div className="w-100 d-flex">
								...
								<div className="ml-10 w-100">
									<div className="d-flex">
										<div className="mb-5 fs-16 w-50"> Tên nhà hàng: </div>
										<div className="mb-5 fs-16 w-100"> {user?.nameRes} </div>
									</div>
									<div className="d-flex">
										<div className="mb-5 fs-16 w-50"> Loại nhà hàng: </div>
										<div className="mb-5 fs-16 w-100"> {user?.categoryRestaurantName} </div>
									</div>
									<div className="d-flex">
										<div className="mb-5 fs-16 w-50"> Số điện thoại: </div>
										<div className="mb-5 fs-16 w-100"> {user?.phone} </div>
									</div>
									<div className="d-flex">
										<div className="mb-5 fs-16 w-50"> Địa chỉ: </div>
										<div className="mb-5 fs-16 w-100"> {user?.address} </div>
									</div>
									<div className="d-flex">
										<div className="mb-5 fs-16 w-50"> Giá đặt bàn: </div>
										<div className="mb-5 fs-16 w-100"> {formatNumberToK(user?.price)} </div>
									</div>
									<div className="d-flex">
										<div className="mb-5 fs-16 w-50"> Thời gian hoạt động: </div>
										<div className="w-100"> 
											<div> Mở cửa: <span className="fs-16"> {user?.openTime} </span> </div>
											<div> Đóng cửa: <span className="fs-16"> {user?.closeTime} </span> </div>
										</div>
									</div>
								</div>
							</div>
						...
						<Col span={10}>
							<div> 
								<div className="pl-20 title-type-1">Mô tả chi tiết</div>
								<div className="">
									<div className="primary fs-16 fw-500">Mô tả ngắn gọn</div>
									<div>
										{user?.subdescription ? (
									...
									<div className="primary fs-16 fw-500">Mô tả chi tiết</div>
									<div>
										{user?.description ? (
