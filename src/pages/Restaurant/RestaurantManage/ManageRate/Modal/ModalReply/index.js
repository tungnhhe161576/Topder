    ...
    const footer = () => {
        return (
            <div className="d-flex justify-content-center">
                ...
                <Button className="mr-10 fw-600" type="primary" shape='round' onClick={() => handleReply()} loading={loading}>
                    Tạo
                </Button>
            </div>
        )
        ...
        >
            ...
            <div className="mt-20 mb-30">
                <div className="mb-10">
                    {
                        open?.isReply 
                            ? <div>Ngày tạo: {dayjs(open?.feedbackReply?.createDate).format('DD-MM-YYYY HH:mm')}</div>
                            : <></>
                    }
                </div>
                <Form form={form} layout="vertical">
                    ...
                    >
                        <TextArea rows={6} placeholder="Phản hồi" disabled={open?.isReply ? true : false}/>
                    </Form.Item>                   
                </Form>
            </div>
        </CustomModal>
