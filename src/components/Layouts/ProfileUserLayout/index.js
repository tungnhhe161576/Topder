						...
						<div className="left">
							...
							<div className="menu">
								...
								<div
									className={`menu-item ${
										isActive(
											"/user-profile/transactiom-history"
										)
											? "active"
											: ""
									}`}
								...
								<div
									className={`menu-item ${
										isActive("/user-profile/user-wallet")
											? "active"
											: ""
									}`}
									onClick={() =>
								...
								>
									...
									<div className="item-name">Ví của tôi</div>
								</div>
								<div
									className={`menu-item ${
										isActive("/user-profile/wishlist")
											? "active"
											: ""
									}`}
									onClick={() =>
										nav("/user-profile/wishlist")
									}
								>
									<div className="icon">
										<HeartFilled />
									</div>
									<div className="item-name">Yêu thích</div>
								</div>
								<div
									className={`menu-item ${
										isActive("/user-profile/rates")
											? "active"
											: ""
									}`}
								...
								>
									...
									<div className="item-name">Đánh giá</div>
								</div>
								<div
									className={`menu-item ${
										isActive(
									...
									onClick={() =>
										nav("/user-profile/change-password")
									}
								>
									<div className="icon">
										<UserSwitchOutlined />
								...
								{/* <div
									className={`menu-item ${
										isActive(
											"/user-profile/authentication-phone"
										)
											? "active"
											: ""
									}`}
